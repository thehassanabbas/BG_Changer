...
function App() {
  ...
  return (
    <div className="w-full h-screen duration-200" style={{ background: color }}>
      <div style={{ background: "white", width: "320px", borderRadius: "10px", padding: "20px 15px", marginLeft: "auto", marginRight: "auto" }} className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
